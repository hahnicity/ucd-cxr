...
def main():
    ...
    train_loader, test_loader = get_openi_loaders(args.images_path, args.train_labels_path, args.test_labels_path, args.batch_size, convert_to='LA', is_preprocessed=is_preprocessed, num_workers=args.num_workers)

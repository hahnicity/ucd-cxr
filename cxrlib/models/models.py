...
class WideResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes):
        ...
        # Adjust from running on CIFAR size images to ImageNet size. 49 is 7*7, and 7 is 224/32.
        in_neurons = nStages[3] * 49
        self.linear = nn.Linear(in_neurons, num_classes)
